...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.22635571.svg)](https://doi.org/10.5281/zenodo.22635571)
...
> Mondal, K., Mandal, A., & Vijay, A. (2026). py_ntcpx v1.1.3 — a reproducible NTCP modelling and machine learning pipeline for radiotherapy dose–volume data (Version 1.1.3) [Dataset]. Zenodo. https://doi.org/10.5281/zenodo.22635571
